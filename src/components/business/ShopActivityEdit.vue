            ...
            <div class="content">
                <div class="biaoti">
                    <el-breadcrumb separator="·">
                        ...
                        <el-breadcrumb-item><span style="color: #30d366;font-weight: bolder">修改店铺活动</span></el-breadcrumb-item>
                    </el-breadcrumb>
                </div>
                <div class="bottom">
                    <div class="title">
                            ...
                            <el-row style="width:850px;">
                                <el-form-item label="*店铺活动名称">
                                    <el-input v-model="form.name"
                                              placeholder="六一儿童节参加活动赢优惠券（部分商品）"
                                              style="width:500px">
                                    </el-input>
                                </el-form-item>
        ...
        data() {
            return {
                form:{
                    ...
                    data:[new Date(2000, 10, 10, 10, 10), new Date(2000, 10, 11, 10, 10)],
                    zhekou:'9折',
                    bankNumber:''
                },
                radio:'1',
